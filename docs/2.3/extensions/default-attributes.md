...
It works by applying the attributes to the nodes during the [`DocumentParsedEvent` event](/customization/abstract-syntax-tree#documentparsedevent) - right after the nodes are parsed but before they are rendered.
